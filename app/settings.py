...
SECRET_KEY = "django-insecure-y&o3v-dc&%k2qrbo*j%oakqwx52pn5lgaa=*1o6!o@1-dgx+t3"
...
STATIC_ROOT = BASE_DIR / 'staticfiles'  # Ensure this folder will be created

# Directory where your static files are located
STATICFILES_DIRS = [
    BASE_DIR / 'static',  # Assuming your app has a static folder
]
